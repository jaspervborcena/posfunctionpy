...
def create_ordersellingtracking_table():
    ...
    bigquery.SchemaField("ordersSellingTrackingId", "STRING"),
        bigquery.SchemaField("batchNumber", "INTEGER"),
        bigquery.SchemaField("cashierEmail", "STRING"),
        ...
        bigquery.SchemaField("isStockTracked", "BOOLEAN"),
        bigquery.SchemaField("runningBalanceTotalStock", "INTEGER"),
